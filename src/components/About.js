          ...
          <div className='row'>
            <div className='col-sm-12 col-md-6'>
              <div className='d-flux justify-content-center'>
                <img  className="about-style mar" src='./images/Vision.png' alt='img' style={{ width: "60%" }} />
              </div>
            </div>
            <div className='col-sm-12 col-md-6'>
          ...
          <div className='row mt-5'>
            ...
            <div className='col-sm-12 col-md-6'>
              <div className='d-flex justify-content-center'>
                <img className="about-style mar1" src='./images/mission.png' alt="img" style={{ width: "60%" }} />
              </div>
            </div>
          </div>
        </div>

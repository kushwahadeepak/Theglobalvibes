  ...
  return (
    <>
      ...
      <div className='row mxs'>
        ...
        <div className='img'>
          <img src='./images/digital3.png' alt='img' style={{ width: "66%", height: "100%", borderRadius: "15px" }} />
        </div>
        </ScrollAnimation>
        </div>
      ...
      <div className='row mxs'>
        ...
        <ScrollAnimation animateIn="fadeInLeft">
        <div className='img'>
          <img src='./images/digital.png' alt='img' style={{ width: "75%", height: "100%", borderRadius: "15px" }} />
        </div>
        </ScrollAnimation>
        </div>
        <div className='col-md-8'>
      ...
      <div className='row mxs'>
        ...
        <ScrollAnimation animateIn="fadeInLeft">
        <div className='img'>
          <img src='./images/digital1.png' alt='img' style={{ width: "75%", height: "100%", borderRadius: "15px" }} />
        </div>
        </ScrollAnimation>
        </div>
        <div className='col-md-8'>

    ...
    <>
      ...
      <div className='container my-5'>
        <div className='row mxs'>
          ...
          <div className='img'>
            <img src='./images/webd.jpg' alt='img' style={{ width: "90%", height: "100%", borderRadius: "15px" }} />
          </div>
          </ScrollAnimation>
          </div>
        ...
        <div className='row mxs'>
          <div className='col-md-4'>
             <ScrollAnimation animateIn="fadeInLeft">
          <div className='img'>
            <img src='./images/webpag.png' alt='img' style={{ width: "88%", height: "100%", borderRadius: "15px" }} />
          </div>
          </ScrollAnimation>
          </div>
          <div className='col-md-8'>
        ...
        <div className='row mxs'>
          <div className='col-md-4'>
             <ScrollAnimation animateIn="fadeInLeft">
          <div className='img'>
            <img src='./images/webpage.jpg' alt='img' style={{ width: "70%", height: "100%", borderRadius: "15px" }} />
          </div>
          </ScrollAnimation>
          </div>
          <div className='col-md-8'>

    ...
    <>
     ...
     <div className='container my-5'>
        <div className='row mxs'>
          ...
          <div className='img'>
            <img src='./images/tech.png' alt='img' style={{ width: "62%", height: "100%", borderRadius: "15px" }} />
          </div>
          </ScrollAnimation>
          </div>
        ...
        <div className='row mxs'>
          <div className='col-md-4'>
            <ScrollAnimation animateIn="fadeInLeft">
          <div className='img'>
            <img src='./images/techn.jpg' alt='img' style={{ width: "85%", height: "100%", borderRadius: "15px" }} />
          </div>
          </ScrollAnimation>
          </div>
          <div className='col-md-8'>
        ...
        <div className='row mxs'>
          <div className='col-md-4'>
            <ScrollAnimation animateIn="fadeInLeft">
          <div className='img'>
            <img src='./images/techni.jpg' alt='img' style={{ width: "60%", height: "100%", borderRadius: "15px" }} />
          </div>
          </ScrollAnimation>
          </div>
          <div className='col-md-8'>

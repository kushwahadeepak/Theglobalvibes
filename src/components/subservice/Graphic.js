    ...
    <>
      ...
      <div className='row mxs'>
        <div className='col-md-4'>
          ...
          <div className='img'>
            <img src='./images/Graphic.jpg' alt='img' style={{ width: "100%", height: "100%", borderRadius: "15px", marginBottom:"15px" }} />
          </div>
          </ScrollAnimation>
        </div>
      ...
      <div className='row mxs'>
        <div className='col-md-4'>
           <ScrollAnimation animateIn="fadeInLeft">
          <div className='img'>
            <img src='./images/Graphicd.jpg' alt='img' style={{ width: "100%", height: "100%", borderRadius: "15px", marginBottom:"15px" }} />
          </div>
          </ScrollAnimation>
        </div>
        <div className='col-md-8'>
      ...
      <div className='row mxs'>
        <div className='col-md-4'>
           <ScrollAnimation animateIn="fadeInLeft">
          <div className='img'>
            <img src='./images/Graphicdg.jpg' alt='img' style={{ width: "100%", height: "100%", borderRadius: "15px", marginBottom:"15px" }} />
          </div>
          </ScrollAnimation>
        </div>
        <div className='col-md-8'>

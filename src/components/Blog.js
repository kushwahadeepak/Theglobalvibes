      ...
      <div className='container'>
        <div className='row my-5'>
          ...
          <ScrollAnimation animateIn="fadeInLeft">
            <div className='img'>
              <img src='./images/img3.jpg' alt='img' style={{ width: "94%", height: "100%", borderRadius: "15px" }} />
            </div>
            </ScrollAnimation>
          </div>
          <div className='col-sm-12 col-md-6'>
        ...
        <div className='row mb-5'>
          ...
          <ScrollAnimation animateIn="fadeInRight">
            <div className='img'>
              <img src='./images/img2.jpg' alt='img' style={{ width: "94%", height: "100%", borderRadius: "15px" }} />
            </div>
            </ScrollAnimation>
          </div>
        ...
        <div className='row mb-5 pt-3'>
          ...
          <ScrollAnimation animateIn="fadeInLeft">
            <div className='img'>
              <img src='./images/img4.jpg' alt='img' style={{ width: "95%", height: "100%", borderRadius: "15px" }} />
            </div>
            </ScrollAnimation>
          </div>
          <div className='col-sm-12 col-md-6'>
